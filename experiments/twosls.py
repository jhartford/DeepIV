...
parser.add_argument('-n', '--n_samples', help='Number of training samples', default=5000, type=int)
...
def df(n, s, test): return data_generator.demand(n, s, ypcor=args.endo, test=test)
