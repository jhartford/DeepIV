...
class Response(Model):
    ...
    def _prepare_generator(self, batch_size, n_samples=2, seed=123):
    ...
    def fit(self, x=None, y=None, batch_size=32, epochs=1, verbose=1, callbacks=None,
        ...
        generator = self._prepare_generator(batch_size, samples_per_batch, seed)
        steps_per_epoch = y.shape[0] * batch_size
        super(Response, self).fit_generator(generator=generator, steps_per_epoch=steps_per_epoch,
